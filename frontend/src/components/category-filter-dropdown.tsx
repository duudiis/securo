    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          ...
          className={
            triggerClassName ??
            `inline-flex min-w-[10rem] h-8 items-center gap-1.5 justify-between rounded-md border border-border px-3 text-sm bg-background hover:bg-hover transition-colors focus:outline-none focus-visible:ring-ring/30 focus-visible:ring-[2px]`
          }
        >
